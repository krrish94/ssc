...
% Setup dataset paths
suncgDataPath = '/home/krishna/datasets/SUNCG/';
suncgToolboxPath = '/home/krishna/code/SUNCGtoolbox/';
renderedDir = '/home/krishna/datasets/SUNCG/rendered/';
cameraDir = '//home/krishna/datasets/SUNCG/rendered/camera_v2/';
pathtogaps = fullfile(suncgToolboxPath, '/gaps/bin/x86_64');
outputDir = '/home/krishna/datasets/SUNCG/output/';
% Directory to store amodal output (i.e., includes scene voxels outside
% FOV)
outputDir_amodal = '/home/krishna/datasets/SUNCG/output_amodal';
% Directory to store color images
outputDir_rgb = '//home/krishna/datasets/SUNCG/output_rgb';
% Directory to store depth images
outputDir_depth = '/home/krishna/datasets/SUNCG/output_depth';
